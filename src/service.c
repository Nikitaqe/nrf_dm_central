...
void service_distance_measurement_update(const bt_addr_le_t *addr,
                                         const struct dm_result *result) {
...
static const struct bt_ddfs_cb cb = {.dm_ranging_mode_set = dm_ranging_mode_set,
